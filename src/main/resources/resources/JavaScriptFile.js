...
function setResourcesForFamilyDD() {
	...
	finalResponse += "<b>Resource </b> <select name=\"resourceCandidatesForFamilyCheckbox\" id=\"resourceCandidatesForFamilyCheckbox\" multiple style=\"width: 370px;\"> ";
	...
	for (var i = 0; i < resourceCandidatesForFamilyCheckbox.length; i++) {
		...
		finalResponse+=" <option value=\""+resourceCandidatesForFamilyCheckbox[i].trim()+"\"\">"+resourceCandidatesForFamilyCheckbox[i].trim()+"</option>";
	}
